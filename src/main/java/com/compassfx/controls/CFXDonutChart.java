...
import com.compassfx.skins.CFXDonutChartSkin;
...
/**
 * CompassFX Donut Chart - A Material Design inspired donut chart
 */
public class CFXDonutChart extends Control {

    private static final String DEFAULT_STYLE_CLASS = "cfx-donut-chart";
    ...
    public CFXDonutChart() {
        ...
        this.showLabels = new SimpleBooleanProperty(this, "showLabels", false);
        this.animated = new SimpleBooleanProperty(this, "animated", true);
        this.title = new SimpleStringProperty(this, "title", "");
        this.centerText = new SimpleStringProperty(this, "centerText", "");
        this.innerRadius = new SimpleDoubleProperty(this, "innerRadius", 0.6);
    ...
    protected Skin<?> createDefaultSkin() {
        return new CFXDonutChartSkin(this);
    }
    ...
    public String getCenterText() { return centerText.get(); }
    public void setCenterText(String centerText) { this.centerText.set(centerText); }
    public StringProperty centerTextProperty() { return centerText; }

    public double getInnerRadius() { return innerRadius.get(); }
    public void setInnerRadius(double innerRadius) { this.innerRadius.set(innerRadius); }
    public DoubleProperty innerRadiusProperty() { return innerRadius; }
